# -*- coding: utf-8 -*-
# Generated by Django 1.10 on 2016-08-01 22:24
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('price', djmoney.models.fields.MoneyField(decimal_places=2, default=Decimal('0.0'), default_currency='USD', max_digits=7)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('total_charge', djmoney.models.fields.MoneyField(decimal_places=2, default=Decimal('0.0'), default_currency='USD', max_digits=7)),
                ('name', models.CharField(max_length=100)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('status', models.CharField(default='reserved', max_length=25)),
                ('order', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='Bikes.Bikes')),
                ('user_info', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='Bikes.Order')),
            ],
        ),
        migrations.AddField(
            model_name='bikes',
