...
urlpatterns = [
    ...
    url(r'superuser/ready to ship/(?P<pk>\d+)/$', views.shipping_order, name="mark shipped"),
    ...
    url(r'user/change address/(?P<pk>\d+)/$', views.change_address, name='change_address'),
    url(r'user/edit card/(?P<pk>\d+)/$', views.edit_card, name='edit_card'),
    url(r'user/change card/(?P<pk>\d+)/$', views.change_card, name='change_card'),
